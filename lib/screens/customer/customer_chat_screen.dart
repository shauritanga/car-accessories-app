...
class CustomerChatScreen extends ConsumerStatefulWidget {
  ...
  const CustomerChatScreen({required this.conversationId, required this.otherUserId, Key? key}) : super(key: key);
              ...
              builder: (context, snapshot) {
                ...
                for (final msg in messages) {
                  if (!msg.isRead && msg.receiverId == user.id) {
                    MessagingService().markMessageAsRead(widget.conversationId, msg.id);
                  }
                }
